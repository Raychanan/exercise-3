...
$stmt = $db->prepare('SELECT posts.*, comments.id as comment_id, comments.author as comment_author, comments.body as comment_body FROM posts JOIN comments ON posts.id = comments.post_id WHERE posts.id = ?');
...
<body>
  ...
  <div class="leave-comment">
    ...
    <h3>
      <?php echo count($results); ?> Comments
    </h3>
